...
from classification.features import mlp, holtwinters


class HWExperiment(Experiment):
    ...
    def run(self, log_dir, classes):
        ...
        extractor=holtwinters.HoltWintersCoeffsExtractor()
...
if __name__=="__main__":
    ...
    HWExperiment().run(log_dir, classes)
